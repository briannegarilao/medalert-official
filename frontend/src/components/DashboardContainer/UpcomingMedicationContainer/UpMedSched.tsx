...
function UpMedSched() {
  ...
  return (
    ...
    >
      {/* Main container with a card-style layout */}
      <div className="d-flex flex-column justify-content-start align-items-center h-100">
        ...
        {/* Container for displaying medications */}
        <div
          className="container"
          style={{
            maxHeight: "350px",
        ...
        >
          {medications.length === 0 ? (
            // Display a message when no medications are scheduled for the selected month
            <div>
              <p>No medications scheduled for today.</p>
              <p>Tap "Add Medicine" to get started!</p>
            </div>
          ) : (
            // Display medication cards for each medication
