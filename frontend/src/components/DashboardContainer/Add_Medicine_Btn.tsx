...
import MedInfo from "../NewMedicine/Step1MedInfo";
import SetTime from "../NewMedicine/Step2MedInfo";
import SetDate from "../NewMedicine/Step3MedInfo";
                  ...
                  <div className="row mb-3">
                    <div className="col-md-10">
                      <h2
                        ...
                        style={{ textAlign: "left", fontSize: 18 }}
                      >
                        MEDICINE INFORMATION - SET TIME
                      </h2>
                    </div>
                    <div className="col-md-2 d-flex align-items-center justify-content-end">
                      <button
                        onClick={toggleStep2Visibility}
                        type="button"
                        className="btn-close"
                        aria-label="Close"
                      ></button>
                ...
                <div className="card-body">
                  <div className="row mb-3">
                    <div className="col-md-10">
                      ...
                      >
                        MEDICINE INFORMATION - SET TIME - SET DATE
                      </h2>
                    </div>
                    <div className="col-md-2 d-flex align-items-center justify-content-end">
                      <button
                        onClick={toggleStep3Visibility}
                        type="button"
                        className="btn-close"
                        aria-label="Close"
                      ></button>
